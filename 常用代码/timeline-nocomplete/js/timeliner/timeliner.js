...
;(function($) {
	...
	$.timeliner = function(options){
		...
		settings = jQuery.extend({
			...
			expandAllText: '+ 展开全部', // value: string, sets the text of the expandAll selector after the timeline is fully collapsed
			collapseAllText: '- 收起全部' // // value: string, sets the text of the expandAll selector after the timeline is fully expanded
		}, options);
